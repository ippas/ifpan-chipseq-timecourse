...
$ACCESS_PATH_4/./bigwig_genomic_range_extract_normalize_to_tsv.sh $ACCESS_PATH_3/enhancer_delta_ep300_info.tsv > $ACCESS_PATH_2/enhancer_peaks_delta_ep300.tsv
