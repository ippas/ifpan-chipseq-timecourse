...
#########################################################################################################################################
#enhancer_top_ep300_info.tsv

cat $ACCESS_PATH_3/enhancer_top_ep300_info.tsv |
   tail +2 |
...
$ACCESS_PATH_4/./bigwig_genomic_amplitude_extract_normalize_to_tsv.sh $FILE_4 > $ACCESS_PATH_2/enhancer_amplitude_top_ep300.tsv
...
$ACCESS_PATH_4/./bigwig_genomic_range_extract_normalize_to_tsv.sh $FILE_4 > $ACCESS_PATH_2/enhancer_peaks_top_ep300.tsv
...
#########################################################################################################################################
#enhancer_delta_ep300_info.tsv

cat $ACCESS_PATH_3/enhancer_delta_ep300_info.tsv |
   tail +2 |
   awk '{print "chr"$3"\t"$4"\t"$5"\t"$0}' |
   sed 's/\t-[0-9]*/\t0/g' > $FILE_2
...
$ACCESS_PATH_4/./bigwig_genomic_amplitude_extract_normalize_to_tsv.sh $FILE_4 > $ACCESS_PATH_2/enhancer_amplitude_delta_ep300.tsv
...
$ACCESS_PATH_4/./bigwig_genomic_range_extract_normalize_to_tsv.sh $FILE_4 > $ACCESS_PATH_2/enhancer_peaks_delta_ep300.tsv
